...
/**
 * The [RecyclerView] items spacing decorator for [GridLayoutManager] which applies spacing
 * between [RecyclerView] and child.
 *
 * Optionally can apply spacing between [RecyclerView] edges and his child
 * based on the[includeEdges] parameter.
 */
public class GridSpacingDecorator extends RecyclerView.ItemDecoration {
    ...
    public GridSpacingDecorator(int spanCount, int spacing, boolean includeEdge) {
